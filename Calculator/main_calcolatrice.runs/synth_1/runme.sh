...
HD_PWD='C:/Users/maria/Desktop/calcolatrice_prova_divisione/main_calcolatrice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_calcolatrice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_calcolatrice.tcl
